 ...
 * @param {empty} 
 * @returns {Promise<Currency>} ArrayOfObject
 */
const getCurrencyListServices = async () => {
    const currencyData = await query_helper.findData(Currency, {}, { currencyName: 1, currencySymbol: 1, currencyId: 1 }, { }, 0);
    return { data: currencyData.msg};
}
/**
